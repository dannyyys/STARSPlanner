class StudentMainPageLogic implements IMainPageLogic{
    private IStudentController _studentController;
    private ICourseController _courseController;

    public StudentMainPageLogic(IStudentController studentController, ICourseController courseController) {
